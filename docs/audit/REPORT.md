...
**This is not a final report.** 29 of 130 defects are still open, most of them
...
| P3 | 23 | 8 `BUG`, 7 `UX`, 3 `ARCH`, 2 `PERF`, 2 `PKG`, 1 `SEC`. Edge cases, cosmetic divergences, and comments or tests that describe something the code does not do. |
