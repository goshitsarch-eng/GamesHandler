...
**This is not a final report.** 34 of 130 defects are still open, most of them
...
|---|---|---|---|---|---|
| `BUG-xx` | Bugs, reliability, feature completeness | 46 | 37 | 2 | 9 |
| `ARCH-xx` | Architecture, code quality | 25 | 18 | 1 | 7 |
| `UX-xx` | libcosmic / COSMIC UX | 29 | 18 | 1 | 11 |
...
| P3 | 28 | 9 `UX`, 8 `BUG`, 5 `ARCH`, 2 `PERF`, 2 `PKG`, 2 `SEC`. Edge cases, cosmetic divergences, and comments or tests that describe something the code does not do. |
