...
**This is not a final report.** 32 of 130 defects are still open, most of them
...
| `ARCH-xx` | Architecture, code quality | 25 | 20 | 1 | 5 |
...
| P3 | 26 | 10 `UX`, 8 `BUG`, 3 `ARCH`, 2 `PERF`, 2 `PKG`, 1 `SEC`. Edge cases, cosmetic divergences, and comments or tests that describe something the code does not do. |
