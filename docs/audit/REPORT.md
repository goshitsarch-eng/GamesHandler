...
**This is not a final report.** 39 of 130 defects are still open, most of them
...
|---|---|---|---|---|---|
| `BUG-xx` | Bugs, reliability, feature completeness | 46 | 33 | 2 | 13 |
| `ARCH-xx` | Architecture, code quality | 25 | 18 | 1 | 7 |
| `UX-xx` | libcosmic / COSMIC UX | 29 | 17 | 1 | 12 |
| `PERF-xx` | Performance, resource | 8 | 6 | 0 | 2 |
| `SEC-xx` | Security, robustness | 11 | 9 | 0 | 2 |
...
| P3 | 33 | 12 `BUG`, 10 `UX`, 5 `ARCH`, 2 `PERF`, 2 `PKG`, 2 `SEC`. Edge cases, cosmetic divergences, and comments or tests that describe something the code does not do. |
