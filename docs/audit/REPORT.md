...
**This is not a final report.** 33 of 130 defects are still open, most of them
...
| `UX-xx` | libcosmic / COSMIC UX | 29 | 19 | 1 | 10 |
...
| P3 | 27 | 8 `BUG`, 8 `UX`, 5 `ARCH`, 2 `PERF`, 2 `PKG`, 2 `SEC`. Edge cases, cosmetic divergences, and comments or tests that describe something the code does not do. |
