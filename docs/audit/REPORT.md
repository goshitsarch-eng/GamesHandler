...
**This is not a final report.** 18 of 130 defects are still open, most of them
...
| P3 | 12 | 7 `UX`, 2 `PERF`, 2 `PKG`, 1 `SEC`. Edge cases, cosmetic divergences, and comments or tests that describe something the code does not do. |
