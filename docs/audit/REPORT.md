...
**This is not a final report.** 12 of 130 defects are still open, most of them
...
| P3 | 6 | 2 `PERF`, 2 `UX`, 1 `PKG`, 1 `SEC`. Edge cases, cosmetic divergences, and comments or tests that describe something the code does not do. |
