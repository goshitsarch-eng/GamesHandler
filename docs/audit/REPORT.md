...
**This is not a final report.** 48 of 129 defects are still open, most of them
...
| `UX-xx` | libcosmic / COSMIC UX | 29 | 14 | 1 | 15 |
...
| P2 | 11 | Actionable. The largest concentration is `UX` (5); the rest are 4 `ARCH`, 1 `BUG` and 1 `PKG`. |
