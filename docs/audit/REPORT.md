...
| `ARCH-xx` | Architecture, code quality | 25 | 19 | 1 | 6 |
...
| P3 | 27 | 10 `UX`, 8 `BUG`, 4 `ARCH`, 2 `PERF`, 2 `PKG`, 1 `SEC`. Edge cases, cosmetic divergences, and comments or tests that describe something the code does not do. |
