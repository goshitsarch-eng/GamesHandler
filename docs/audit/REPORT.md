...
**This is not a final report.** 20 of 130 defects are still open, most of them
...
|---|---|---|---|---|---|
| `BUG-xx` | Bugs, reliability, feature completeness | 46 | 43 | 2 | 3 |
...
| P3 | 14 | 7 `UX`, 2 `BUG`, 2 `PERF`, 2 `PKG`, 1 `SEC`. Edge cases, cosmetic divergences, and comments or tests that describe something the code does not do. |
