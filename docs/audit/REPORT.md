...
**This is not a final report.** 50 of 129 defects are still open, most of them
...
|---|---|---|---|---|---|
| `BUG-xx` | Bugs, reliability, feature completeness | 46 | 31 | 2 | 15 |
...
| P3 | 38 | Edge cases, cosmetic divergences, and comments or tests that describe something the code does not do. The 14 open `BUG` rows are all here, along with 10 `UX`, 5 `ARCH`, 4 `SEC`, 3 `PKG` and 2 `PERF`. |
